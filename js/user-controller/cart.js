        ...
        <div class="bg-white/70 backdrop-blur-2xl rounded-[4rem] p-12 border border-white shadow-xl animate-in slide-in-from-right-10 duration-700 min-h-[70vh] flex flex-col">
            <div class="flex justify-between items-center mb-10">
                <div>
                    ...
                    <p class="text-slate-400 text-xs font-bold uppercase tracking-widest mt-1">Bạn có ${cartBooks.length} cuốn sách chờ xác nhận</p>
                </div>
                ${cartBooks.length > 0 ? `
                ...
                <div class="flex-1 p-6 md:border-r border-slate-100">
                    ...
                    <div class="space-y-6">
                        <div class="bg-slate-50 p-6 rounded-3xl">
                            ...
                            <p class="text-lg font-bold text-slate-800">${currentUser?.hoTen}</p>
                            <p class="text-xs text-slate-500 font-mono">ID: ${currentUser?.id}</p>
                        </div>
                        ...
                        <div>
                            <p class="text-[10px] font-black uppercase text-slate-400 tracking-widest mb-3">Sách đăng ký (${cartBooks.length})</p>
